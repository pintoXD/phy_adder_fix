...
# Generated on: Wed Jan 15 10:36:24 -03 2025 (Wed Jan 15 13:36:24 UTC 2025)
...
set_log_file fv/somador/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/somador -revised fv_map
...
add_search_path /home/cinovador/Downloads/somador_fisico_UPDATE/backend/synthesis/deliverables /home/cinovador/Downloads/somador_fisico_UPDATE/frontend -design -golden
read_design -rangeconstraint -configuration  -enumconstraint -golden -lastmod -noelab  -vhdl 93  /home/cinovador/Downloads/somador_fisico_UPDATE/frontend/somador.vhd
elaborate_design -golden -root {somador} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/somador/fv_map.v.gz
elaborate_design -revised -root {somador}
...
#add_name_alias fv/somador/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/somador/rtl_to_fv_map.log
}
